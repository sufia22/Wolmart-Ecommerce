            ...
            <div className="container">
              ...
              <div className="header-right">
                ...
                <div className="dropdown">
                  <a href="#language">
                    <img
                      src="src/assets/images/flags/eng.png"
                      alt="ENG Flag"
                      width="14"
                      height="8"
                  ...
                  <div className="dropdown-box">
                    ...
                    <a href="#FRA">
                      <img
                        src="src/assets/images/flags/fra.png"
                        alt="FRA Flag"
                        width="14"
                        height="8"
                        className="dropdown-image"
                ...
                <a
                  href="src/assets/ajax/login.html"
                    ...
                    <div className="products">
                      <div className="product product-cart">
                        ...
                        <figure className="product-media">
                          <a href="product-default.html">
                            <img
                              src="src/assets/images/cart/product-1.jpg"
                              alt="product"
                              height="84"
                              width="94"
                            />
                      ...
                      <div className="product product-cart">
                        ...
                        <figure className="product-media">
                          <a href="product-default.html">
                            <img
                              src="src/assets/images/cart/product-2.jpg"
                              alt="product"
                              width="84"
                              height="94"
                            />
                            ...
                            <li className="row">
                              <div className="col-6">
                                <div className="banner banner-fixed menu-banner5 br-xs">
                                  <figure>
                                    <img
                                      src="src/assets/images/menu/banner-5.jpg"
                                      alt="Banner"
                                      width="410"
                                      height="123"
                              ...
                              <div className="col-6">
                                <div className="banner banner-fixed menu-banner5 br-xs">
                                  <figure>
                                    <img
                                      src="src/assets/images/menu/banner-6.jpg"
                                      alt="Banner"
                                      width="410"
                                      height="123"
